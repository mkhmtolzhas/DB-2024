...
-- 9
select sum(budget) as sum_of_buged from departments;

-- 10
select department, count(*) as employe_count from employees group by department;

-- 11
select department, count(*) as employe_count from employees group by department having count(*) > 2;
...
-- 14
select customers.name, customers.lastname, employees.name, employees.lastname from employees, customers where customers.city = 'Almaty' or employees.city = 'Almaty';
